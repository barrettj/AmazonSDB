...
@synthesize regionEndPoint, version, responseDictionary = responseDictionary_, hasNextToken = hasNextToken_, failed = failed_, accessKey = _accessKey, secretKey = _secretKey;
